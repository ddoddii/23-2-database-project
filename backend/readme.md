...
### 사용자 관리
- [ ] 사용자 만드는 기능
  - [ ] 사용자 type 은 관리자(1), 일반 사용자(0) 으로 한다
- [ ] 사용자 로그인 기능
- [ ] 관리자는 사용자의 목록과 글 제출 상태를 관리할 수 있다. 

### 글 쓰기
- [ ] 사용자가 로그인해서 글을 쓴다.
  - [ ] 글 내용은 이미지, 비디오 가 포함될 수 있다.
  - [ ] 보여지는 글에는 작성시간, 수정시간, 글 작성자, 글 내용, 글 조회수가 있다. 
- [ ] 처음 글을 쓰면 조회수(view_count) 는 0이고, 중요도(help_count)도 0이다.
- [ ] 사용자는 본인이 작성한 글을 편집할 수 있다. 
- [ ] 사용자는 본인이 작성한 글을 삭제할 수 있다.

### 답글 쓰기
- [ ] 사용자는 로그인해서 다른 사용자들의 글 / 본인의 글에 답글을 달 수 있다.
- [ ] 사용자는 본인이 작성한 답글을 편집할 수 있다. 
- [ ] 사용자는 본인이 작성한 답글을 삭제할 수 있다.

### 글 / 답글 조회
- [ ] 사용자는 키워드로 글을 검색할 수 있다.
- [ ] 사용자는 로그인해서 다른 사용자들의 글 / 답글을 볼 수 있다.
- [ ] 사용자가 글 / 답글의 내용을 볼 때마다 조회수가 1 씩 올라간다. 
- [ ] 사용자는 작성시간 , 조회수, 중요도 수 등의 조건으로 글을 조회할 수 있다.

### 중요해요 누르기
- [ ] 사용자는 로그인해서 다른 사람의 글 / 답글에 '중요해요' 를 선택할 수 있다.
- [ ] '중요해요' 를 선택하면 글/답글의 help_count 가 1씩 증가한다. 
